    ...
    >
      ...
      <div className='bg-white rounded-xl p-6 shadow-lg transition-all duration-300 group-hover:shadow-xl relative'>
        ...
        <div className='flex items-center mb-4 pt-2'>
          <div className='mr-4'>{icons[0].icon}</div>
  ...
  const features = [
    {
      ...
      title: "Move & Track",
      description:
        "Just start exercising - our app tracks everything automatically!",
      icons: [
        {
    ...
    },
    {
      ...
      icons: [
        {
          icon: <Joystick className='w-10 h-10 text-primary' />,
          label: "Gaming",
        },
      ],
    },
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className='max-w-7xl mx-auto px-6'>
        ...
        {/* Feature Steps */}
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 md:mb-16 px-4 sm:px-6'>
        ...
        <m.div
          ...
          whileInView={{ opacity: 1 }}
          viewport={{ once: true, margin: "-100px" }}
          className='bg-gradient-to-r from-primary/10 to-primary/5 rounded-2xl p-6 sm:p-8 text-center relative overflow-hidden mx-4 sm:mx-6'
        >
          <h3 className='text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 relative'>
            Start Now!
          </h3>
          <a
            href='#signup-section'
            className='inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-primary text-white rounded-full font-medium hover:bg-primary-hover transition-colors text-base sm:text-lg relative'
          >
            Join Free <ArrowRight className='w-4 h-4 sm:w-5 sm:h-5' />
          </a>
        </m.div>
      </div>
    </LazyMotion>
